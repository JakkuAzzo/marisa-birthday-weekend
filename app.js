(() => {
  ...
  const renderMarisaWrapped = ({ autoplay = false } = {}) => {
    ...
    const itinerary = [
      ...
      { date: "SAT · 22 AUG", label: "Clapham pub & night out", items: [["16:00", "Wetherspoons meet", "The London and South Western, Clapham Junction"], ["19:00", "Meet at Infernos", "Infernos Nightclub, Clapham"], ["22:00", "Infernos nightclub", "Infernos Nightclub, Clapham"]] }
    ];
  ...
  const calendarEvents = [
    ...
    ["20260822T190000", "20260822T220000", "Meet at Infernos", "Infernos Nightclub, 146 Clapham High Street, London, SW4 7UH"],
  ...
  const setupItineraryPopups = () => {
    ...
    const itineraries = [
      ...
      { day: "Saturday 22 August", label: "Clapham pub & night out", date: "SAT · 22 AUG", items: [
        ...
        { time: "19:00–22:00", title: "Meet at Infernos", location: "Infernos Nightclub, Clapham", directions: "https://www.google.com/maps/search/?api=1&query=Infernos+Nightclub+Clapham" },
